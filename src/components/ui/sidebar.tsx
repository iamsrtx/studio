      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex h-full w-full has-[[data-variant=inset]]:bg-sidebar", // Use h-full
              className
            )}
            ref={ref}
            {...props}
...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden h-full md:block text-sidebar-foreground" // Use h-full
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-full w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex", // Use h-full
            side === "left"
